...
#define ArrayType 8 // Pointer type - not using
#define ListType 9 // Pointer type - using
...
void reportNum(const char *msg, int n); // First arg is a label (like analog pin 3), second arg is the value of the pin
