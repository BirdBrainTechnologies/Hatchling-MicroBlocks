...
#define STACK_LIMIT 54 // Task size is 6 + STACK_LIMIT words - V2 could go higher. This only really gets hit in recursive functions. Each function call is 3 words, parameters add a word per call
...
#define MAX_TASKS 10 // For V1, V2 could probably go higher
